...
@Component({ // Main app component
    ...
    template: `
        ...
        <app-text> Where originally links, but navigation is now something different. I don't know about multiple router-outlet stuff, so we do this now :)</app-text>

        <home></home>
        <user-greeter></user-greeter>

    `,
    imports: [TextComponent, CounterComponent, NgOptimizedImage, RouterOutlet, RouterLink, Home, UserGreeterComponent],
})
